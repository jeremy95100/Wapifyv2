      ...
      <main className="pt-32 pb-16 px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="bg-wapify-panel/60 backdrop-blur-sm border-2 border-wapify-border rounded-2xl p-12">
            <p className="text-lg text-wapify-text-secondary mb-6">
              This page is under construction. Check back soon!
            </p>
            <p className="text-sm text-wapify-text-secondary">
              We'll be launching a Discord server for the Wapify community where you can share your projects, get help, and connect with other developers.
            </p>
          </div>
        </div>
      </main>
